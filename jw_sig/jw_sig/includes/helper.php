...
class SimpleImageGalleryHelper
{
    ...
    public function renderGallery()
    {
        ...
        $srcFolder = JFolder::files($sitePath.$srcimgfolder, '\.jpg|\.jpeg|\.png|\.gif|\.webp|\.mp4|\.webm|\.JPG|\.JPEG|\.PNG|\.GIF|\.WEBP|\.MP4|\.WEBM', false, true);
        ...
        foreach ($srcFolder as $srcFile) {
            ...
            if (in_array($ext, array('jpg', 'jpeg', 'png', 'gif', 'webp', 'mp4', 'webm', 'JPG', 'JPEG', 'PNG', 'GIF', 'WEBP', 'MP4', 'WEBM'))) {
